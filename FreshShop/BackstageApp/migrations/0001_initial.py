# Generated by Django 2.1.8 on 2019-07-22 07:20
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('goods_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='BackstageApp.Goods', verbose_name='商品id')),
            ],
        ),
        migrations.CreateModel(
            name='seller',
            fields=[
                ...
                ('picture', models.ImageField(blank=True, null=True, upload_to='BackstageApp/images', verbose_name='用户头像')),
        ...
        migrations.AddField(
            model_name='store',
            name='type',
            field=models.ManyToManyField(to='BackstageApp.StoreType', verbose_name='店铺类型'),
        ),
        migrations.AddField(
            model_name='goods',
            name='store_id',
            field=models.ManyToManyField(to='BackstageApp.Store', verbose_name='商品店铺'),
        ),
    ]
